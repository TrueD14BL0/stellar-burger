...
export const GET_USER_ORDERS_DATA = "GET_USER_ORDERS_DATA";
export const ON_USER_ERROR_SOCKET = "ON_USER_ERROR_SOCKET";
export const ON_USER_CLOSE_SOCKET = "ON_USER_CLOSE_SOCKET";
